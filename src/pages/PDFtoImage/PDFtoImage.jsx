    ...
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6">
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-zinc-400">
          Extract every page of your PDF into high-resolution JPEGs. 
          Downloaded instantly as a ZIP file.
        </p>
      </div>
              ...
              {isProcessing ? (
                ...
                >
                  ...
                  <span className="text-emerald-500/80 text-sm mt-1">
                    ZIP Archive created successfully ({formatFileSize(result.size)})
                  </span>
                </motion.div>
              ) : null}
            </AnimatePresence>
